...
{
    public partial class alter_UpsertProductSP : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("ALTER PROC _sp_ProductUpsert @Id int, @Name nvarchar(100), @Desc nvarchar(100), " +
                                "@Price decimal, @CategoryId int, @Img nvarchar(100), @newId int output " +
                                "AS " +
                                "BEGIN " +
