...
{
    public partial class alterSPUpdteProdut : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"Alter proc _sp_UpdateProduct @ProdId int, @Name nvarchar(50), @Desc nvarchar(100), @Price decimal, @CategoryId int, @Img nvarchar(100) " +
